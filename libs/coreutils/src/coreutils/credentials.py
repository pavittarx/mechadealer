...
from .paths import creds_dir as default_creds_dir


class CredentialsManager:
    def __init__(self, creds_dir: str | Path | None = None):
        self.creds_dir = Path(creds_dir) if creds_dir else default_creds_dir()
